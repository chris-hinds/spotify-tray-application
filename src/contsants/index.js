...
export const ACTION_PLAYER_TRACK_UPDATE = "ACTION_PLAYER_TRACK_UPDATE";
...
export const ACTION_PLAYER_PREV = "ACTION_PLAYER_PREV";
export const ACTION_PLAYER_TOGGLE_PLAYBACK = "ACTION_PLAYER_TOGGLE_PLAYBACK";
